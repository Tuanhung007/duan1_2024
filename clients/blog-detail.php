                ...
                <ul class="mini-cart-list mb-0 list-unstyled position-relative w-100">
                    <li>
                        <div class="mini-cart-item d-flex flex-wrap position-relative w-100">
                            ...
                            <div class="mini-cart-img overflow-hidden"><a href="product-detail2.html" title=""><img
                                        class="img-fluid w-100" src="assets/images/resources/mini-cart-img1-1.jpg"
                    ...
                    <li>
                        <div class="mini-cart-item d-flex flex-wrap position-relative w-100">
                            <a class="remove-cart position-absolute rounded-circle" href="javascript:void(0);"
                                title=""><i class="fi fi-rr-cross-small"></i></a>
                            <div class="mini-cart-img overflow-hidden"><a href="product-detail2.html" title=""><img
                                        class="img-fluid w-100" src="assets/images/resources/mini-cart-img1-2.jpg"
                    ...
                    <li>
                        <div class="mini-cart-item d-flex flex-wrap position-relative w-100">
                            <a class="remove-cart position-absolute rounded-circle" href="javascript:void(0);"
                                title=""><i class="fi fi-rr-cross-small"></i></a>
                            <div class="mini-cart-img overflow-hidden"><a href="product-detail2.html" title=""><img
                                        class="img-fluid w-100" src="assets/images/resources/mini-cart-img1-3.jpg"
                    ...
                    <li>
                        <div class="mini-cart-item d-flex flex-wrap position-relative w-100">
                            <a class="remove-cart position-absolute rounded-circle" href="javascript:void(0);"
                                title=""><i class="fi fi-rr-cross-small"></i></a>
                            <div class="mini-cart-img overflow-hidden"><a href="product-detail2.html" title=""><img
                                        class="img-fluid w-100" src="assets/images/resources/mini-cart-img1-4.jpg"
                ...
                <div class="responsive-topbar-inner d-flex flex-wrap align-items-center justify-content-between w-100">
                    ...
                    <div class="logo-menu-inner-right d-flex flex-wrap align-items-center justify-content-end">
                        <ul class="wishlist-and-cart d-flex flex-wrap align-items-center mb-0 list-unstyled">
                            <li>
                                <a class="whishlist-trigger d-inline-block" href="javascript:void(0);" title=""><i
                                        class="fi fi-rr-heart"></i></a>
                                <div class="mini-cart-dropdown position-absolute w-100">
                                    <div class="mini-cart-dropdown-inner w-100">
                                        <div
                                            class="mini-cart-head d-flex flex-wrap align-items-center justify-content-between w-100">
                                            <h4>Wishlist</h4>
                                            <a class="mini-cart-close d-inline-block" href="javascript:void(0);"
                                                title=""><i class="fi fi-rr-cross-small"></i></a>
                                        </div>
                                        <ul class="mini-cart-list mb-0 list-unstyled position-relative w-100">
                                            <li>
                                                <div class="mini-cart-item d-flex flex-wrap position-relative w-100">
                                                    <a class="remove-cart position-absolute rounded-circle"
                                                        href="javascript:void(0);" title=""><i
                                                            class="fi fi-rr-cross-small"></i></a>
                                                    <div class="mini-cart-img overflow-hidden"><a
                                                            href="product-detail.html" title=""><img
                                                                class="img-fluid w-100"
                                                                src="assets/images/resources/mini-cart-img1-1.jpg"
                                                                alt="Mini Cart Image 1"></a></div>
                                                    <div class="mini-cart-info">
                                                        <h6 class="mb-0"><a href="product-detail.html" title="">Commodo
                                                                Blown Lamp</a></h6>
                                                        <div
                                                            class="mini-cart-btm d-flex flex-wrap align-items-center justify-content-between">
                                                            <div class="product-quanty"><input type="number" class="qty"
                                                                    value="01"></div>
                                                            <span class="price">$275.00</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="mini-cart-bottom w-100">
                                            <div
                                                class="mini-cart-total d-flex flex-wrap align-items-center justify-content-between">
                                                <span>Subtotal:</span>
                                                <span class="price">$524.00</span>
                                            </div>
                                            <div
                                                class="btns-group d-flex flex-wrap align-items-center justify-content-between">
                                                <a class="theme-btn bg-color1 brd-btn" href="cart.html" title="">View
                                                    Cart<span></span><span></span><span></span><span></span></a>
                                                <a class="theme-btn bg-color1" href="checkout.html"
                                                    title="">Checkout<span></span><span></span><span></span><span></span></a>
                            ...
                            <li>
                                <a class="responsive-menu-trigger d-inline-block" href="javascript:void(0);" title=""><i
                                        class="fi fi-rr-align-justify"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <ul class="mb-0 list-unstyled w-100">
            <li class="menu-item-has-children"><a href="javascript:void(0);" title="">Home</a>
                <ul class="children mb-0 list-unstyled w-100">
                    <li><a href="index-2.html" title="">Home Style 1</a></li>
            ...
            <div class="container">
                <div class="post-detail position-relative w-100">
                    <div class="post-detail-info w-100">
                        <h1 class="mb-0">Whether you're kicking off a new campaign or looking to revamp your strategy,
                            you'll learn will be universal to all small business email marketing.</h1>
                        <div class="post-detail-mini-author align-items-center d-flex flex-wrap">
                            <img class="img-fluid rounded-circle" src="assets/images/resources/author-img.jpg"
                                alt="Author Image 1" height="50" width="50">
                    ...
                    <div class="post-detail-content w-100">
                        <p>Habitasse per feugiat aliquam luctus accumsan curae, suspendisse aliquam taciti eros neque,
                            ...
                            duis erat feugiat cras sociosqu porta ut praesent, fermentum donec convallis tellus
                            vulputate duis nibh rhoncus phasellus dui massa nisl.</p>
                        <p>Whether you’re kicking off a new campaign or looking to revamp your strategy, you’ll learn
                            will be universal to all small business email marketing.</p>
                        <p>MailChimp is an email marketing service provider founded in 2001. It has 9 million users that
                            collectively send over 15 billion emails through the service each month. Whether you’re
                            kicking off a new campaign or looking to revamp your strategy.</p>
                        ...
                        <blockquote>
                            <p>Email is a crucial channel in any marketing mix, and never has this been truer than for
                                ...
                                resources., nd never has this been truer than for today’s entrepreneur.</p>
                        </blockquote>
                        ...
                        <p>Email is a crucial channel in any marketing mix, and never has this been truer than for
                            ...
                            today’s entrepreneur.</p>
                        <p>Curious what to say? How to say it? How often to hit “send”? Each bite-sized lesson delivers
                            core concepts, guiding questions, and tactical how-to resources. guiding questions, and
                            ...
                            <div class="row mrg30">
                                <div class="col-md-6 col-sm-12 col-lg-6">
                                    <div class="post-gallery-box overflow-hidden position-relative w-100"><a
                                            ...
                                            data-fancybox="gallery" title=""><img class="img-fluid w-100"
                                                src="assets/images/resources/post-gallery-img1-1.jpg"
                                ...
                                <div class="col-md-6 col-sm-12 col-lg-6">
                                    <div class="post-gallery-box overflow-hidden position-relative w-100"><a
                                            ...
                                            data-fancybox="gallery" title=""><img class="img-fluid w-100"
                                                src="assets/images/resources/post-gallery-img1-2.jpg"
                        ...
                        <p>Email is a crucial channel in any marketing mix, and never has this been truer than for
                            ...
                            today’s entrepreneur.</p>
                        <p>Curious what to say? How to say it? How often to hit “send”? Each bite-sized lesson delivers
                            core concepts, guiding questions, and tactical how-to resources.</p>
                    </div>
                    ...
                    <div class="post-detail-author-info bg-color5 align-items-center d-flex flex-wrap w-100">
                        <img class="img-fluid rounded-circle" src="assets/images/resources/author-img.jpg"
                            alt="Author Image 1" height="100" width="100">
                        <div class="post-detail-info-inner">
                            <h5 class="mb-0">Theresa Underwood</h5>
                            <p class="mb-0">Email is a crucial channel in any marketing mix, and never has this been
                                truer than for today’s entrepreneur. Curious what to say? How to say it? How often to
                                hit “send”? Each bite-sized lesson delivers core concepts, guiding questions, and
                                tactical how-to resources. Email is a crucial channel in any marketing mix, and never
                                has this been truer than for today’s entrepreneur.</p>
                            <div class="share-links d-flex flex-wrap">
                                <a href="https://www.facebook.com/" title="Facebook" target="_blank"><i
                        ...
                        <ul class="comments list-unstyled mb-0 w-100">
                            <li>
                                <div class="comment d-flex flex-wrap w-100">
                                    <img class="img-fluid rounded-circle" src="assets/images/resources/comment-img1.jpg"
                                        alt="Comment Image 1" height="60" width="60">
                                    <div class="comment-detail">
                                        <h5>Annette Black</h5>
                                        <span class="post-detail-date-reply text-color4">Februrary 14, 2021<a
                                                href="javascript:void(0);" title=""><i
                                                    class="fas fa-reply"></i></a></span>
                                        <p>Email is a crucial channel in any marketing mix, and never has this been
                                            truer than for today’s entrepreneur. Curious what to say? How to say it? How
                                            ...
                                            marketing mix, and never has this been truer than for today’s entrepreneur.
                                        </p>
                                    </div>
                                </div><!-- Comments -->
                            </li>
                            <li>
                                <div class="comment d-flex flex-wrap w-100">
                                    <img class="img-fluid rounded-circle" src="assets/images/resources/comment-img2.jpg"
                                        alt="Comment Image 2" height="60" width="60">
                                    <div class="comment-detail">
                                        <h5>Wade Warren</h5>
                                        <span class="post-detail-date-reply text-color4">Februrary 14, 2021<a
                                                href="javascript:void(0);" title=""><i
                                                    class="fas fa-reply"></i></a></span>
                                        <p>How to say it? How often to hit “send”? Each bite-sized lesson delivers core
                                            concepts, guiding questions, and tactical how-to resources. Email is a
                                            crucial channel in any marketing mix, and never has this been truer than for
                                            today’s entrepreneur.</p>
                                    </div>
                                </div><!-- Comments -->
                            </li>
                            <li>
                                <div class="comment d-flex flex-wrap w-100">
                                    <img class="img-fluid rounded-circle" src="assets/images/resources/comment-img3.jpg"
                                        alt="Comment Image 3" height="60" width="60">
                                    <div class="comment-detail">
                                        <h5>Ronald Richards</h5>
                                        <span class="post-detail-date-reply text-color4">Februrary 14, 2021<a
                                                href="javascript:void(0);" title=""><i
                                                    class="fas fa-reply"></i></a></span>
                                        <p>Curious what to say? How to say it? How often to hit “send”? Each bite-sized
                                            lesson delivers core concepts, guiding questions, and tactical how-to
                                            resources. Email is a crucial channel in any marketing mix, and never has
                                            this been truer than for today’s entrepreneur. Email is a crucial channel in
                                            any marketing mix, and never has this been truer than for today’s
                                            entrepreneur. Curious what to say? Email is a crucial channel in any
                                            marketing mix, and never has this been truer than for today’s entrepreneur.
                                            Curious what to say?</p>
                                    </div>
                                </div><!-- Comments -->
                            </li>
                        </ul><!-- Comments -->
                                ...
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <div class="field-btn position-relative w-100">
                                        <button class="theme-btn bg-color1"
                                            type="submit">Send<span></span><span></span><span></span><span></span></button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <div class="w-100 pb-120 position-relative">
            <div class="container">
                <div class="sec-title-wrap d-flex flex-wrap align-items-end justify-content-between w-100">
                    ...
                    <div class="sec-btn">
                        <a class="theme-btn bg-color1 brd-btn" href="blog2.html" title="">View
                    ...
                    <div class="row mrg30">
                        <div class="col-md-6 col-sm-6 col-lg-4">
                            <div class="post-box w-100">
                                <div class="post-img overflow-hidden position-relative w-100">
                                    <a href="blog-detail2.html" title=""><img class="img-fluid w-100"
                                            src="assets/images/resources/post-img1-1.jpg" alt="Post Image 1"></a>
                                </div>
                                <div class="post-info w-100">
                                    <h4 class="mb-0"><a href="blog-detail2.html" title="">They're born from love and
                                            bred for individuality</a></h4>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-4">
                            <div class="post-box w-100">
                                ...
                                <div class="post-info w-100">
                                    <h4 class="mb-0"><a href="blog-detail.html" title="">They're born from love and bred
                                            for individuality</a></h4>
                                    <span class="post-date d-block"><a href="javascript:void(0);" title="">Jun 16,
                                            2021</a></span>
                                </div>
                            </div>
            ...
            <div class="container">
                            ...
                            <div class="widget w-100">
                                <div class="logo">
                                    <h1 class="mb-0"><a href="index-2.html" title="Home"><img class="img-fluid"
                                                src="assets/images/logo.svg" alt="Logo"></a></h1>
                                </div><!-- Logo -->
                ...
                <div class="bottom-bar d-flex flex-wrap align-items-center justify-content-between w-100">
                    <ul class="bottom-links d-flex flex-wrap align-items-center list-unstyled mb-0">
                        ...
                        <li>&copy; <a href="index-2.html" title="">Liami</a> All rights reserved.</li>
                    </ul><!-- Bottom Links -->
