                            ...
                            <tbody>
                                <tr class="cart-item">
                                    <td>
                                        ...
                                        <div class="cart-product-box d-flex flex-wrap align-items-center">
                                            <div class="cart-product-img overflow-hidden"><a href="product-detail.html" title=""><img class="img-fluid w-100" src="assets/images/resources/cart-img1-1.jpg" alt="Cart Image 1"></a></div>
                                            <h5 class="mb-0"><a href="product-detail.html" title="">Digital Product</a></h5>
                                        </div>
                                    </td>
                                ...
                                <tr class="cart-item">
                                    <td>
                                        <a class="remove-product d-inline-block rounded-circle" href="javascript:void(0);" title=""><i class="fi fi-rr-cross-small"></i></a>
                                        <div class="cart-product-box d-flex flex-wrap align-items-center">
                                            <div class="cart-product-img overflow-hidden"><a href="product-detail2.html" title=""><img class="img-fluid w-100" src="assets/images/resources/cart-img1-2.jpg" alt="Cart Image 2"></a></div>
                                            <h5 class="mb-0"><a href="product-detail2.html" title="">Digital Product</a></h5>
                                        </div>
                                    </td>
                                    <td><span class="price">$124.00</span></td>
                                    <td>In Stock</td>
                                ...
                                <tr class="cart-item">
                                    <td>
                                        <a class="remove-product d-inline-block rounded-circle" href="javascript:void(0);" title=""><i class="fi fi-rr-cross-small"></i></a>
                                        <div class="cart-product-box d-flex flex-wrap align-items-center">
                                            <div class="cart-product-img overflow-hidden"><a href="product-detail3.html" title=""><img class="img-fluid w-100" src="assets/images/resources/cart-img1-3.jpg" alt="Cart Image 3"></a></div>
                                            <h5 class="mb-0"><a href="product-detail3.html" title="">Digital Product</a></h5>
                                        </div>
                                    </td>
                                    <td><span class="price">$124.00</span></td>
                                    <td>In Stock</td>
